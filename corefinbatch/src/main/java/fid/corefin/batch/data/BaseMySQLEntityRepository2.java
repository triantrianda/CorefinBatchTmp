...
@Singleton
public abstract class BaseMySQLEntityRepository2<T> {
		
	@PersistenceContext(unitName = "finCorefinBatchDS")
	...
	public BaseMySQLEntityRepository2() {
	}
	
	public BaseMySQLEntityRepository2(Class<T> entityClass){
		super();
